![TumoroteK version 2.2.0-beta-2-SNAPSHOT](https://img.shields.io/badge/TumoroteK-2.2.0-beta-2-SNAPSHOT-brightgreen.svg "TumoroteK version 2.2.0-beta-2-SNAPSHOT")

#### Installation de TumoroteK version 2.2.0-beta-2-SNAPSHOT
...
[Dossier d'installation](https://github.com/TumoroteK/TumoroteK/releases/download/v2.2.0-beta-2-SNAPSHOT/tumorotek-install-2.2.0-beta-2-SNAPSHOT.zip)
...
- Déplacer la web archive `tumorotek##2.2.0-beta-2-SNAPSHOT.war` dans le dossier `<PATH_TOMCAT>/webapps`
...
- Edition des variables d'environnement JNDI dans le fichier `<PATH_TOMCAT>/conf/Catalina/localhost/tumorotek##2.2.0-beta-2-SNAPSHOT.xml` :
...
6. LDAP / ActiveDirectory
    ...
    `<TOMCAT_PATH>/webapps/tumorotek##2.2.0-beta-2-SNAPSHOT/WEB-INF/classes/applicationContext-security.xml` afin de commenter/décommenter 
...
7. Niveaux de logs Log4j
    ...
    Se référer à la documentation Log4j pour l'édition du fichier `<TOMCAT_PATH>/webapps/tumorotek##2.2.0-beta-2-SNAPSHOT/WEB-INF/classes/log4j.properties`
...
- **URL** : http://localhost:8080/tumorotek  
- **login** : ADMIN_TUMO  
- **pass** : tk4\[teAm]
